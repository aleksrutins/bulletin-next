...
export interface paths {
    ...
    "/items/articles/{id}": {
       ...
       */
      delete: operations["deleteSingleItemsArticles"];
      /**
       * Update an Item
    ...
    "/items/columns": {
      /**
       * List Items
       * @description List the columns items.
       */
      get: operations["readItemsColumns"];
      /**
       * Create an Item
       * @description Create a new columns item.
       */
      post: operations["createItemsColumns"];
      /**
       * Delete Multiple Items
       * @description Delete multiple existing columns items.
       */
      delete: operations["deleteItemsColumns"];
      /**
       * Update Multiple Items
       * @description Update multiple columns items at the same time.
       */
      patch: operations["updateItemsColumns"];
    };
    "/items/columns/{id}": {
      /**
       * Retrieve an Item
       * @description Retrieve a single columns item by unique identifier.
       */
      get: operations["readSingleItemsColumns"];
      /**
       * Delete an Item
       * @description Delete an existing columns item.
       */
      delete: operations["deleteSingleItemsColumns"];
      /**
       * Update an Item
       * @description Update an existing columns item.
       */
      patch: operations["updateSingleItemsColumns"];
    };
    "/items/issues": {
      /**
       * List Items
       * @description List the issues items.
       */
      get: operations["readItemsIssues"];
      /**
       * Create an Item
       * @description Create a new issues item.
       */
      post: operations["createItemsIssues"];
      /**
       * Delete Multiple Items
       * @description Delete multiple existing issues items.
       */
      delete: operations["deleteItemsIssues"];
      /**
       * Update Multiple Items
       * @description Update multiple issues items at the same time.
       */
      patch: operations["updateItemsIssues"];
    };
    "/items/issues/{id}": {
      /**
       * Retrieve an Item
       * @description Retrieve a single issues item by unique identifier.
       */
      get: operations["readSingleItemsIssues"];
      /**
       * Delete an Item
       * @description Delete an existing issues item.
       */
      delete: operations["deleteSingleItemsIssues"];
      /**
       * Update an Item
       * @description Update an existing issues item.
       */
      patch: operations["updateSingleItemsIssues"];
    };
    "/activity": {
      /**
  ...
  export interface components {
    schemas: {
      ...
      ItemsArticles: {
        ...
        title?: string | null;
        column?: number | components["schemas"]["ItemsColumns"] | null;
        categories?: unknown;
        issue?: number | components["schemas"]["ItemsIssues"] | null;
        author?: string;
        content?: string;
        summary?: string | null;
        type?: string;
  ...
  export interface operations {
    ...
    createItemsArticles: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsArticles"][] | components["schemas"]["ItemsArticles"];
        };
      };
      responses: {
        /** @description Successful request */
    ...
    readItemsColumns: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": {
              data?: components["schemas"]["ItemsColumns"][];
              meta?: components["schemas"]["x-metadata"];
            };
          };
        };
    ...
    createItemsColumns: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsColumns"][] | components["schemas"]["ItemsColumns"];
        };
      };
      responses: {
        /** @description Successful request */
    ...
    updateSingleItemsColumns: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsColumns"];
        };
      };
      responses: {
        /** @description Successful request */
    ...
    readItemsIssues: {
      ...
      responses: {
        ...
        200: {
          content: {
            "application/json": {
              data?: components["schemas"]["ItemsIssues"][];
              meta?: components["schemas"]["x-metadata"];
            };
          };
        };
    ...
    createItemsIssues: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsIssues"][] | components["schemas"]["ItemsIssues"];
        };
      };
      responses: {
        /** @description Successful request */
    ...
    updateSingleItemsIssues: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["ItemsIssues"];
        };
      };
      responses: {
        /** @description Successful request */
  ...
  export type Schema = {
    ...
    columns: components["schemas"]["ItemsColumns"][];
    issues: components["schemas"]["ItemsIssues"][];
  };
